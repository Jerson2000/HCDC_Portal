...
import com.jerson.hcdc_portal.data.repository.ChatGPTRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @ViewModelScoped
    abstract fun bindsChatGPTRepository(gtpRepositoryImpl: ChatGPTRepositoryImpl):ChatGPTRepository
